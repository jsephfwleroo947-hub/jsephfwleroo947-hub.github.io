...
| **Microsoft Entra (formerly Azure AD)** | Cloud-based identity and access management, used to manage sign-ins, device compliance, and policy enforcement across an organisation's devices |
...
## How these connect in practice

These aren't separate boxes to tick — they work together:
...
- **Zero trust** ties both together as an overarching philosophy — assume breach is possible, and verify constantly rather than trusting anything by default just because it's "inside" the network
