...
Security frameworks and compliance standards exist to turn good security practice into something structured, verifiable and uniformed. This section covers the wider compliance landscape beyond Cyber Essentials (covered in Cybersecurity Fundamentals), including data protection law and broader security frameworks.

## Where this comes from

During my placement, I was involved in a **Microsoft Purview** project focused on data protection and posture. The company handled extremely sensitive client information, meaning data protection was beyond that of a background compliance exercise but a central part of daily operations. This gave me direct, practical exposure to what GDPR compliance actually looks like in practice and processes organisations use to enforce them.
...
Frameworks and compliance requirements exist because ad hoc security, left to individual discretion, fails at scale. Seeing Purview used in a real high-stakes environment showed me that compliance is only meaningful when backed by actual technical enforcement, not just policy documents - the same principle that distinguishes Cyber Essentials from Cyber Essentials Plus.
