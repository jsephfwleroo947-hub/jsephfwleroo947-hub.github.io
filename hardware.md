...
Understanding what's physically happening inside a machine isn't just background knowledge — it's the foundation everything else in IT and cybersecurity sits on top of. You can't properly secure, troubleshoot, or explain an attack on a system you don't understand at a fundamental level. This section covers the core hardware components, what each one does, and how they work together.

## Where this comes from

During my IT MSP placement, I worked hands-on with laptop builds, which included fully disassembling and reassembling machines and wiping SSDs (solid-state drives) before redeployment. Taking a laptop apart down to its individual components — rather than just knowing they exist in theory — made the relationship between hardware and software genuinely click for me. It's one thing to read that a CPU "processes instructions"; it's another to physically hold the component and understand its place in the whole system.
...
Understanding hardware isn't just academic — it directly informs real security practice:
